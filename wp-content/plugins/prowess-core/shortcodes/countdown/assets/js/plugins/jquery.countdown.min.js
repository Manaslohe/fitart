    ...
    m.JQPlugin.createPlugin({
        ...
        _init: function() {
            ...
            !r || m.noRequestAnimationFrame ? (m.noRequestAnimationFrame = null, m.countdown._timer = setInterval(function() {
                s._updateElems()
            }, 1e3)) : (a = window.animationStartTime || window.webkitAnimationStartTime || window.mozAnimationStartTime || window.oAnimationStartTime || window.msAnimationStartTime || n(), r(function e(t) {
                var i = t < 1e12 ? o ? window.performance.now() + window.performance.timing.navigationStart : n() : t || n();
                1e3 <= i - a && (s._updateElems(), a = i), r(e)
            }))
        },
        ...
        _updateCountdown: function(e, t) {
            if (e = e.jquery ? e : m(e), (t = t || this._getInst(e)) && t.options) {
            ...
            } else t._until && window.onerror("Countdown not properly destroyed. Until:" + t._until.toString(), "jquery.countdown.js", 404)
        },
        ...
        _adjustSettings: function(e, t, i) {
            ...
            var o = null,
                r = null;
            if (this._eqNull(s)) {
                var a = m.isFunction(t.options.serverSync) ? t.options.serverSync.apply(e[0], []) : null;
                o = new Date, r = a ? o.getTime() - a.getTime() : 0, this._serverSyncs.push([t.options.serverSync, r])
            } else o = new Date, r = t.options.serverSync ? s : 0;
            var l = t.options.timezone;
            l = this._eqNull(l) ? -o.getTimezoneOffset() : l, (i || !i && this._eqNull(t._until) && this._eqNull(t._since)) && (t._since = t.options.since, this._eqNull(t._since) || (t._since = this.UTCDate(l, this._determineTime(t._since, null)), t._since && r && t._since.setMilliseconds(t._since.getMilliseconds() + r)), t._until = this.UTCDate(l, this._determineTime(t.options.until, o)), r && t._until.setMilliseconds(t._until.getMilliseconds() + r)), t._show = this._determineShow(t)
        },
        ...
        _determineTime: function(e, t) {
            var i, s, p = this,
                n = this._eqNull(e) ? t : "string" == typeof e ? function(e) {
                    e = e.toLowerCase();
                    for (var t = new Date, i = t.getFullYear(), s = t.getMonth(), n = t.getDate(), o = t.getHours(), r = t.getMinutes(), a = t.getSeconds(), l = /([+-]?[0-9]+)\s*(s|m|h|d|w|o|y)?/g, _ = l.exec(e); _;) {
                        switch (_[2] || "s") {
                            case "s":
                                a += parseInt(_[1], 10);
                                break;
        ...
        _generateHTML: function(i) {
            ...
            var e = !1,
                ...
                o = m.extend({}, i._show),
                r = null;
            for (r = 0; r <= 6; r++) e = e || "?" === i._show[r] && 0 < i._periods[r], o[r] = "?" !== i._show[r] || e ? i._show[r] : null, t += o[r] ? 1 : 0, n -= 0 < i._periods[r] ? 1 : 0;
            var a = [!1, !1, !1, !1, !1, !1, !1];
            for (r = 6; 0 <= r; r--) i._show[r] && (i._periods[r] ? a[r] = !0 : (a[r] = 0 < n, n--));
            ...
            function _(e) {
                ...
                return !i.options.significant && o[e] || i.options.significant && a[e] ? '<span class="' + s._sectionClass + '"><span class="' + s._amountClass + '">' + s._minDigits(i, i._periods[e], u) + '</span><span class="' + s._periodClass + '">' + (t ? t[e] : p[e]) + "</span></span>" : ""
            }
            ...
            return i.options.layout ? this._buildLayout(i, o, i.options.layout, i.options.compact, i.options.significant, a) : (i.options.compact ? '<span class="' + this._rowClass + " " + this._amountClass + (i._hold ? " " + this._holdingClass : "") + '">' + l(0) + l(1) + l(2) + l(3) + (o[4] ? this._minDigits(i, i._periods[4], 2) : "") + (o[5] ? (o[4] ? i.options.timeSeparator : "") + this._minDigits(i, i._periods[5], 2) : "") + (o[6] ? (o[4] || o[5] ? i.options.timeSeparator : "") + this._minDigits(i, i._periods[6], 2) : "") : '<span class="' + this._rowClass + " " + this._showClass + (i.options.significant || t) + (i._hold ? " " + this._holdingClass : "") + '">' + _(0) + _(1) + _(2) + _(3) + _(4) + _(5) + _(6)) + "</span>" + (i.options.description ? '<span class="' + this._rowClass + " " + this._descrClass + '">' + i.options.description + "</span>" : "")
        },
        _buildLayout: function(i, e, t, s, n, o) {
            for (var r = i.options[s ? "compactLabels" : "labels"], a = i.options.whichLabels || this._normalLabels, l = function(e) {
                    return (i.options[(s ? "compactLabels" : "labels") + a(i._periods[e])] || r)[e]
                }, _ = function(e, t) {
                ...
                var d = "yowdhms".charAt(u),
                    h = new RegExp("\\{" + d + "<\\}([\\s\\S]*)\\{" + d + ">\\}", "g");
                c = c.replace(h, !n && e[u] || n && o[u] ? "$1" : "")
            }
        ...
        _calculatePeriods: function(e, i, t, s) {
            ...
            var h = Math.floor((n.getTime() - s.getTime()) / 1e3),
                m = null;
            if (d(2, 604800), d(3, 86400), d(4, 3600), d(5, 60), d(6, 1), 0 < h && !e._since) {
                var g = [1, 12, 4.3482, 7, 24, 60, 60],
                    w = 6,
                    f = 1;
                for (m = 6; 0 <= m; m--) i[m] && (o[w] >= f && (o[w] = 0, h = 1), 0 < h && (o[m]++, h = 0, w = m, f = 1)), f *= g[m]
            }
            if (t)
